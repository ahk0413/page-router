  ...
  return (
    <>
      ...
      <div>
        <form
          onSubmit={onSubmit}
          className="borer border-gray-600 m-4 p-2 rounded flex justify-center items-center"
        >
          ...
          <button
            type="submit"
            className="bg-blue-500 px-2 rounded py-0.5 font-bold ml-2"
          >
            검색
          </button>
        </form>
